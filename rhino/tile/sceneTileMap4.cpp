...
bool SceneTileMap4::loadTileMapFromCSV(const QString& file,bool fromtop)
{
...
int SceneTileMap4::getTileIDByTilePos(int x,int y)
{
	int index = x * col + y;
...
void SceneTileMap4::initGL()
{
}

void SceneTileMap4::glDraw()
{
...
void SceneTileMap4::qtDraw(QWidget* widget)
{
}

void SceneTileMap4::update(int time)
{
}
